  ...
  <div class="post_job_form">
    ...
    >
      ...
      <el-form-item
        ...
        prop="temps"
      >
        <el-radio-group v-model="jobForm.temps">
      ...
      >
        <el-radio-group v-model="jobForm.contractType">
          <el-radio label="CDI"></el-radio>
          <el-radio label="CDD"></el-radio>
          <el-radio label="STAGE"></el-radio>
        </el-radio-group>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async addJob(e) {
      ...
      await store.dispatch("ADD_JOB", {
        title: this.jobForm.title,
        // description: this.jobForm.desc,
